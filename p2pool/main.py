...
def main(args, net, datadir_path, merged_urls, worker_endpoint):
    try:
        ...
        web_root = web.get_web_root(wb, datadir_path, bitcoind_getinfo_var, static_dir=args.web_static, worker_port=worker_endpoint[1], p2p_port=args.p2pool_port)
...
def run():
    ...
    parser.add_argument('--bugreport',
        help='submit caught exceptions to the original p2pool author (off by default)',
        action='store_false', default=True, dest='no_bugreport')
    parser.add_argument('--no-bugreport',
        help='kept for compatibility; bug reports are off by default',
        action='store_true', dest='no_bugreport')
